...
| `api.v1.declarations.get` | `GET` | `/api/v1/declarations/{declarationId}/revisions/{revision}` | `planned` | `browser, operator` | `finite` | `` | `vegastack-labs.dev/declaration-revision` |
| `api.v1.declarations.revise` | `POST` | `/api/v1/declarations` | `planned` | `browser, operator` | `finite` | `vegastack-labs.dev/declaration-revision-request` | `vegastack-labs.dev/declaration-revision` |
...
| `api.v1.plans.create` | `POST` | `/api/v1/plans` | `planned` | `browser, operator` | `finite` | `vegastack-labs.dev/plan-create-request` | `vegastack-labs.dev/plan` |
...
| `api.v1.plans.get` | `GET` | `/api/v1/plans/{planId}` | `planned` | `browser, operator` | `finite` | `` | `vegastack-labs.dev/plan` |
