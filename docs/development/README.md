...
Status: operating mandate adopted as working v1 and full-scope roadmap approved by the user on 26-08-2026. Phase 0 was accepted on 07-09-2026, and [Phase 1](phases/01-portable-executable-and-generated-contracts.md) was accepted on 08-09-2026 at integrated commit `ed86290`. [Phase 2](phases/02-authoritative-control-service-and-inventory.md) is active with approved briefs 2.1 through 2.10; only individually approved implementation plans authorize work. Pull requests, merges, release, repository administration, and live operations remain separately gated.
...
- [Phase 2 plan](phases/02-authoritative-control-service-and-inventory.md): active protected-service, SQLite-authority, inventory, audit, recovery, API/CLI, export, and combined-exit boundaries.
