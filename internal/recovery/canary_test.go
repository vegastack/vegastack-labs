...
func TestAuthorityEnablesOnlyAfterCompleteCanary(t *testing.T) {
	request := CanaryRequest{PlanID: "plan-a", PlanDigest: "sha256:" + strings.Repeat("a", 64), NewInstanceID: "instance-new", FenceSetDigest: "sha256:" + strings.Repeat("b", 64), RecoveryEpoch: 8, ExpectedStateRevision: 19, CanaryRunID: "run-canary", CanaryStepID: "step-canary", CanaryLeaseID: "lease-canary", CanaryChallengeID: "challenge-canary", CanaryReceiptID: "receipt-canary", ResponsibleHumanID: "human-a", PrincipalMethod: "local-os-peer"}
