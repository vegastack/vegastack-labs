...
func candidateTestBinding() generated.RestoreBinding {
	...
	return generated.RestoreBinding{Schema: generated.SchemaIDRestoreBinding, SchemaVersion: "1.1.0", Source: source, PointID: source.PointID, DependencyIDs: []string{"dependency-a"}, TargetIDs: []string{"control-a"}, TargetDigest: testCandidateDigest("5"), PlanID: "plan-a", PlanDigest: testCandidateDigest("a"), HumanAcknowledgementID: "ack-a", FenceSetDigest: testCandidateDigest("b"), AuditDecisionDigest: testCandidateDigest("c"), CandidateDigest: testCandidateDigest("d"),
		FormerHostID: "former-host", ReplacementHostID: "replacement-host", RecoveryDraftID: "draft-a", CiphertextFingerprint: testCandidateDigest("e"), SourceAdmissionDigest: testCandidateDigest("f"), FenceQualificationDigest: testCandidateDigest("1"), RecoveryRunID: "run-a", RecoveryStepID: "step-a", RecoveryLeaseID: "lease-a", RecoveryChallengeID: "challenge-a", RecoveryReceiptID: "receipt-a",
		CanaryRunID: "canary-run-a", CanaryStepID: "canary-step-a", CanaryLeaseID: "canary-lease-a", CanaryChallengeID: "canary-challenge-a", CanaryReceiptID: "canary-receipt-a", CanaryBindingDigest: testCandidateDigest("2"),
