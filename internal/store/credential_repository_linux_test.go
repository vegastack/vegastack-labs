...
func TestCredentialMigrationAppliesAfterRestorablePreMigrationSnapshot(t *testing.T) {
	...
	if len(catalog) != 15 || catalog[11].ID != 12 || catalog[11].Name != "0012_credential_refs" || catalog[12].ID != 13 || catalog[12].Name != "0013_credential_import_drafts" || catalog[13].ID != 14 || catalog[13].Name != "0014_audit_chain" || catalog[14].ID != 15 || catalog[14].Name != "0015_credential_lifecycle" {
