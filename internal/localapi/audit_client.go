...
func validAuditCheckpointList(value generated.AuditCheckpointListData, envelope generated.RunResult) bool {
	raw, err := json.Marshal(value)
	return err == nil && generated.ValidateContractJSON(generated.SchemaIDAuditCheckpointListData, raw, generated.ContractExact) == nil && value.RecoveryEpoch == envelope.RecoveryEpoch
}

func validAuditVerification(value generated.AuditVerificationData, envelope generated.RunResult) bool {
	raw, err := json.Marshal(value)
	return err == nil && generated.ValidateContractJSON(generated.SchemaIDAuditVerificationData, raw, generated.ContractExact) == nil && value.RecoveryEpoch == envelope.RecoveryEpoch
}
