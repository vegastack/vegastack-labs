...
func backupRetirementDraftCommand() CommandDefinition {
	...
	schemas := []SchemaDefinition{
		...
		},
		{
			...
			Fields: []FieldDefinition{
				...
				{JSONName: "offsiteAccountId", GoName: "OffsiteAccountID", Kind: ValueString, Required: false, Nullable: true, Pattern: `^[a-f0-9]{32}$`},
				{JSONName: "offsiteQualificationDigest", GoName: "OffsiteQualificationDigest", Kind: ValueString, Required: false, Nullable: true, Pattern: `^sha256:[a-f0-9]{64}$`},
				{JSONName: "offsitePutCutoffDigest", GoName: "OffsitePutCutoffDigest", Kind: ValueString, Required: false, Nullable: true, Pattern: `^sha256:[a-f0-9]{64}$`},
				{JSONName: "offsiteMultipartCutoffDigest", GoName: "OffsiteMultipartCutoffDigest", Kind: ValueString, Required: false, Nullable: true, Pattern: `^sha256:[a-f0-9]{64}$`},
				{JSONName: "offsiteAvailableBytes", GoName: "OffsiteAvailableBytes", Kind: ValueInteger, Required: false, Nullable: true, Minimum: int64Pointer(1)},
				{JSONName: "offsiteAvailablePuts", GoName: "OffsiteAvailablePUTs", Kind: ValueInteger, Required: false, Nullable: true, Minimum: int64Pointer(1)},
				{JSONName: "offsiteAvailableLists", GoName: "OffsiteAvailableLISTs", Kind: ValueInteger, Required: false, Nullable: true, Minimum: int64Pointer(1)},
				{JSONName: "offsiteRuleCount", GoName: "OffsiteRuleCount", Kind: ValueInteger, Required: false, Nullable: true, Minimum: int64Pointer(0), Maximum: int64Pointer(1000)},
				{JSONName: "offsiteRetainedGenerations", GoName: "OffsiteRetainedGenerations", Kind: ValueInteger, Required: false, Nullable: true, Minimum: int64Pointer(0)},
			},
		},
		{
