...
func validateCommands(commands []CommandDefinition, schemas map[string]struct{}) error {
	...
	for index, command := range commands {
		...
		case AvailabilityAvailable:
			...
			case "apply", "run cancel", "run resume", "gate evidence", "gate profile draft", "credential import", "backup policy draft", "credential stage", "credential activate", "credential rotate", "credential revoke", "credential recover":
