...
func phase5RecoveryJobSchemas() []SchemaDefinition {
	return []SchemaDefinition{
		...
		phase5RestoreSchema(restoreBindingSchemaID,
			...
			phase5ID("canaryRunId", "CanaryRunID"), phase5ID("canaryStepId", "CanaryStepID"), phase5ID("canaryLeaseId", "CanaryLeaseID"), phase5Digest("canaryBindingDigest", "CanaryBindingDigest"),
