...
func phase4Schemas() []SchemaDefinition {
	...
	return []SchemaDefinition{
		...
		{ID: browserRunStepSchemaID, Version: "1.0.0", Fields: []FieldDefinition{positive("sequence", "Sequence"), id("operationId", "OperationID"), id("operationType", "OperationType"), id("targetId", "TargetID"), id("stepId", "StepID"), FieldDefinition{JSONName: "status", GoName: "Status", Kind: ValueString, Required: true, Enum: phase4RunStates}}},
