...
func syntheticGateRequest(t *testing.T, command string) []byte {
	...
	case generated.CommandNameBackupRun, generated.CommandNameDatabaseBackup:
	...
	case generated.CommandNameBackupVerify, generated.CommandNameDatabaseVerify:
	...
	case generated.CommandNameDatabaseExport:
		value = generated.DatabaseExportRequest{Schema: generated.SchemaIDDatabaseExportRequest, SchemaVersion: "1.0.0", ExpectedStateRevision: 7, RecoveryEpoch: 2, TargetDigest: digest, IdempotencyKey: "export-test", ExportID: "export-test", Kind: "sanitized-control"}
	default:
