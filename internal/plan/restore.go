...
func BuildRestorePlan(ctx context.Context, declaration generated.DeclarationRevision, request generated.RestoreRequest, source generated.RestoreSourceBinding, fences []generated.RestoreFenceItem, decision generated.RestoreAuditDecision) (generated.Plan, generated.RestoreBinding, error) {
	if ctx == nil || ctx.Err() != nil || declaration.DeclarationType != "recovery.restore" || declaration.Status != "draft" || len(declaration.Operations) != 1 || len(declaration.Extensions) != 1 || declaration.Extensions[0].Name != "x-restore-binding" {
	...
	if operation.OperationType != "recovery.restore.cutover" || operation.AdapterID != "core.recovery" || operation.Idempotent || operation.InputDigest != declaration.Extensions[0].ValueDigest {
		return generated.Plan{}, generated.RestoreBinding{}, planError(generated.ErrorCodeInputInvalid)
	}
