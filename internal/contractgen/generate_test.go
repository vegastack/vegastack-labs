...
func TestPhase5GeneratedNamesMatchEveryConsumer(t *testing.T) {
	...
	if phase5 != 28 {
		t.Errorf("Phase 5 endpoint count = %d, want 28", phase5)
	}
	if !reflect.DeepEqual(phase5EndpointIDs, []string{
		...
		"api.v1.restores.run", "api.v1.restores.verify", "api.v1.scheduled-job-policies.drafts.create", "api.v1.scheduled-job-policies.get", "api.v1.scheduled-jobs.create",
	}) {
		t.Errorf("#102 Phase 5 endpoint baseline or #104/#105 scoped additions changed: %v", phase5EndpointIDs)
	}
	if !reflect.DeepEqual(availablePhase5Endpoints, []string{"api.v1.audit-checkpoints.create", "api.v1.audit-checkpoints.list", "api.v1.audit-history.verification", "api.v1.backup-offsite-retirements.dry-run", "api.v1.backup-offsite-retirements.stage", "api.v1.backup-policy-drafts.create", "api.v1.backup-retention-lock-drafts.create", "api.v1.backup-retirement-drafts.create", "api.v1.backups.run", "api.v1.backups.status", "api.v1.backups.verify", "api.v1.credential-lifecycle-drafts.create", "api.v1.credential-references.import-stream", "api.v1.gate-evidence.create", "api.v1.gate-profile-drafts.create", "api.v1.gates.check", "api.v1.gates.get", "api.v1.gates.list", "api.v1.restores.get", "api.v1.restores.plan", "api.v1.restores.run", "api.v1.restores.verify", "api.v1.scheduled-job-policies.drafts.create", "api.v1.scheduled-job-policies.get", "api.v1.scheduled-jobs.create"}) {
...
func TestGeneratedContractsPreservePublicBoundary(t *testing.T) {
	...
	if available != 44 || planned != 28 {
		t.Fatalf("command availability = (%d available, %d planned), want (44, 28)", available, planned)
	}
	...
	if !reflect.DeepEqual(availablePhase5, []string{"audit checkpoints", "audit verify", "backup offsite-retirement dry-run", "backup offsite-retirement stage", "backup policy draft", "backup retention-locks draft", "backup retirement draft", "backup run", "backup status", "backup verify", "credential activate", "credential import", "credential recover", "credential revoke", "credential rotate", "credential stage", "gate check", "gate evidence", "gate inspect", "gate list", "gate profile draft", "recovery witness collect", "restore plan", "restore run", "restore verify", "schedule dispatch", "schedule policy draft"}) {
