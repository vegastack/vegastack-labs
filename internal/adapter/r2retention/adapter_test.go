...
func TestOffsiteJournalFailureAfterRuleEffectRecordsUncertain(t *testing.T) {
	...
	intent := store.OffsiteRetirementIntent{IntentID: "i", GenerationID: "g", BucketID: "b", RuleSetDigest: DigestRuleSet(pre), SurvivorRuleDigest: DigestRuleSet(survivor), RecoveryEpoch: 1, MaxWorkObjects: 2, MaxMutationBytes: 15, Rules: []store.OffsiteRetirementRule{{RuleID: "t1", Prefix: "g/config"}, {RuleID: "t2", Prefix: "g/keys/"}, {RuleID: "t3", Prefix: "g/data/"}, {RuleID: "t4", Prefix: "g/index/"}, {RuleID: "t5", Prefix: "g/snapshots/"}}, Objects: []store.OffsiteRetirementObject{{Key: objects[0].Key, Digest: objects[0].Digest, Bytes: 7}, {Key: objects[1].Key, Digest: objects[1].Digest, Bytes: 8}}}
	lease := store.OffsiteRetirementLease{LeaseID: "l", IntentID: "i", GenerationID: "g", BucketID: "b", LockAdminReferenceID: "a", RetentionReferenceID: "r", RecoveryEpoch: 1, MaxWorkObjects: 2, MaxMutationBytes: 15, MaximumExpiresAt: time.Now().Add(time.Hour)}
...
func TestOffsiteRuleRaceNeverReachesObjectDelete(t *testing.T) {
	...
	intent := store.OffsiteRetirementIntent{IntentID: "intent-a", GenerationID: "generation-a", BucketID: "bucket-a", RuleSetDigest: DigestRuleSet(pre), SurvivorRuleDigest: DigestRuleSet(survivor), RecoveryEpoch: 2, MaxWorkObjects: 1, MaxMutationBytes: 7, Rules: []store.OffsiteRetirementRule{{RuleID: "target-1", Prefix: "g/config"}, {RuleID: "target-2", Prefix: "g/keys/"}, {RuleID: "target-3", Prefix: "g/data/"}, {RuleID: "target-4", Prefix: "g/index/"}, {RuleID: "target-5", Prefix: "g/snapshots/"}}, Objects: []store.OffsiteRetirementObject{{Key: object.Key, Digest: object.Digest, Bytes: object.Bytes}}}
	lease := store.OffsiteRetirementLease{IntentID: intent.IntentID, GenerationID: intent.GenerationID, BucketID: intent.BucketID, LockAdminReferenceID: "lock-admin", RetentionReferenceID: "retention", RecoveryEpoch: 2, MaxWorkObjects: 1, MaxMutationBytes: 7, MaximumExpiresAt: time.Now().Add(time.Hour), LeaseID: "lease-a"}
...
func TestOffsiteDeleteResponseLossStaysUncertain(t *testing.T) {
	...
	survivor := RuleSet{Rules: []Rule{{"s1", "s/config"}}}
	object := Object{"g/data/a", "sha256:aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", 7}
	intent := store.OffsiteRetirementIntent{IntentID: "i", GenerationID: "g", BucketID: "b", RuleSetDigest: DigestRuleSet(pre), SurvivorRuleDigest: DigestRuleSet(survivor), RecoveryEpoch: 1, MaxWorkObjects: 1, MaxMutationBytes: 7, Rules: []store.OffsiteRetirementRule{{RuleID: "t1", Prefix: "g/config"}, {RuleID: "t2", Prefix: "g/keys/"}, {RuleID: "t3", Prefix: "g/data/"}, {RuleID: "t4", Prefix: "g/index/"}, {RuleID: "t5", Prefix: "g/snapshots/"}}, Objects: []store.OffsiteRetirementObject{{Key: object.Key, Digest: object.Digest, Bytes: 7}}}
	lease := store.OffsiteRetirementLease{LeaseID: "l", IntentID: "i", GenerationID: "g", BucketID: "b", LockAdminReferenceID: "a", RetentionReferenceID: "r", RecoveryEpoch: 1, MaxWorkObjects: 1, MaxMutationBytes: 7, MaximumExpiresAt: time.Now().Add(time.Hour)}
