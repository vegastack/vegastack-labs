...
const (
	...
	SchemaIDScheduledPolicyDraftSubmission         = "vegastack-labs.dev/scheduled-policy-draft-submission"
	...
	CommandNameDatabaseBackup                      = "database backup"
	CommandNameDatabaseExport                      = "database export"
	CommandNameDatabaseRestore                     = "database restore"
	CommandNameDatabaseStatus                      = "database status"
	CommandNameDatabaseVerify                      = "database verify"
	...
	CommandNameScheduleCancel                      = "schedule cancel"
	FlagJobID                                      = "--job-id"
...
type BackupRetentionLock struct {
	Schema        string `json:"schema"`
	SchemaVersion string `json:"schemaVersion"`
	PointID       string `json:"pointId"`
	ReasonDigest  string `json:"reasonDigest"`
...
type BackupRetentionLockDraftRequest struct {
	Schema                string                    `json:"schema"`
	SchemaVersion         string                    `json:"schemaVersion"`
	ExpectedStateRevision int64                     `json:"expectedStateRevision"`
	RecoveryEpoch         int64                     `json:"recoveryEpoch"`
	TargetDigest          string                    `json:"targetDigest"`
	IdempotencyKey        string                    `json:"idempotencyKey"`
	Catalog               LocalRetentionLockCatalog `json:"catalog"`
}

type BackupRetentionLockDraftSubmission struct {
	Schema        string `json:"schema"`
	SchemaVersion string `json:"schemaVersion"`
	DraftID       string `json:"draftId"`
...
type BackupRetirementDraftRequest struct {
	Schema                string `json:"schema"`
	SchemaVersion         string `json:"schemaVersion"`
	ExpectedStateRevision int64  `json:"expectedStateRevision"`
	RecoveryEpoch         int64  `json:"recoveryEpoch"`
...
type BackupRetirementDraftSubmission struct {
	Schema                   string   `json:"schema"`
	SchemaVersion            string   `json:"schemaVersion"`
	DraftID                  string   `json:"draftId"`
	ChangeID                 string   `json:"changeId"`
	OperationID              string   `json:"operationId"`
	SelectionDigest          string   `json:"selectionDigest"`
	CredentialManifestDigest string   `json:"credentialManifestDigest"`
	TargetPointIDs           []string `json:"targetPointIds"`
	SurvivorPointIDs         []string `json:"survivorPointIds"`
	Status                   string   `json:"status"`
	StateRevision            int64    `json:"stateRevision"`
...
type DatabaseExportDraftSubmission struct {
	Schema         string `json:"schema"`
	SchemaVersion  string `json:"schemaVersion"`
	DraftID        string `json:"draftId"`
	ChangeID       string `json:"changeId"`
...
type ScheduledJobCancelRequest struct {
	Schema         string `json:"schema"`
	SchemaVersion  string `json:"schemaVersion"`
	IdempotencyKey string `json:"idempotencyKey"`
}
...
type ScheduledJobPolicy struct {
	...
	OperationType          string   `json:"operationType"`
	AdapterID              string   `json:"adapterId"`
	ExactSourceIDs         []string `json:"exactSourceIds"`
	ExactSubjectIDs        []string `json:"exactSubjectIds"`
	ExactTargetIDs         []string `json:"exactTargetIds"`
	MaximumWork            int64    `json:"maximumWork"`
	CredentialReferenceIDs []string `json:"credentialReferenceIds"`
	GrantRevision          int64    `json:"grantRevision"`
	StateRevision          int64    `json:"stateRevision"`
	RecoveryEpoch          int64    `json:"recoveryEpoch"`
	PolicyVersion          string   `json:"policyVersion"`
	RetentionRuleDigest    string   `json:"retentionRuleDigest"`
...
type ScheduledJobRequest struct {
	...
	PolicyID              string `json:"policyId"`
	PolicyRevision        int64  `json:"policyRevision"`
	OccurrenceToken       string `json:"occurrenceToken"`
	ObservedAt            string `json:"observedAt"`
}

type ScheduledPolicyDraftSubmission struct {
	Schema         string `json:"schema"`
	SchemaVersion  string `json:"schemaVersion"`
	DraftID        string `json:"draftId"`
	PolicyID       string `json:"policyId"`
...
var ScheduledJobTransitions = []RunTransition{
	...
	{From: "retry-wait", To: "cancelled"},
	{From: "retry-wait", To: "failed"},
	{From: "retry-wait", To: "running"},
	{From: "running", To: "failed"},
	{From: "running", To: "retry-wait"},
	{From: "running", To: "succeeded"},
	{From: "running", To: "uncertain"},
}
...
var Commands = []Command{
	...
	{Path: []string{"database", "backup"}, Summary: "Execute one exact approved control-database backup plan; qualification still requires database verify.", Availability: "available", OwnerPhase: "5", Risk: "mutation", Flags: []Flag{{Name: "--config", Kind: "value", ValueName: "path", Required: true, Repeatable: false, Summary: "Read one protected server profile.", Enum: []string(nil)}, {Name: "--file", Kind: "value", ValueName: "path", Required: true, Repeatable: false, Summary: "Read one exact material-free database operation request JSON file.", Enum: []string(nil)}, {Name: "--output", Kind: "value", ValueName: "format", Required: false, Repeatable: false, Summary: "Select human or versioned JSON output.", Enum: []string{"human", "json"}}, {Name: "--schema-version", Kind: "value", ValueName: "major", Required: false, Repeatable: false, Summary: "Select the machine-contract schema major.", Enum: []string{"1"}}}, RequestSchema: "vegastack-labs.dev/backup-run-request", ResultSchema: "vegastack-labs.dev/run-result", DataSchema: "vegastack-labs.dev/backup-job", Examples: []Example{{Summary: "Execute one exact approved control-database backup plan; qualification still requires database verify.", Arguments: []string{"database", "backup", "--config", "fixture/server-profile.json", "--file", "fixture/database-backup-request.json", "--output", "json"}}}},
	{Path: []string{"database", "export"}, Summary: "Create an inert authorized sanitized control-data export draft.", Availability: "available", OwnerPhase: "5", Risk: "mutation", Flags: []Flag{{Name: "--config", Kind: "value", ValueName: "path", Required: true, Repeatable: false, Summary: "Read one protected server profile.", Enum: []string(nil)}, {Name: "--file", Kind: "value", ValueName: "path", Required: true, Repeatable: false, Summary: "Read one exact material-free database operation request JSON file.", Enum: []string(nil)}, {Name: "--output", Kind: "value", ValueName: "format", Required: false, Repeatable: false, Summary: "Select human or versioned JSON output.", Enum: []string{"human", "json"}}, {Name: "--schema-version", Kind: "value", ValueName: "major", Required: false, Repeatable: false, Summary: "Select the machine-contract schema major.", Enum: []string{"1"}}}, RequestSchema: "vegastack-labs.dev/database-export-request", ResultSchema: "vegastack-labs.dev/run-result", DataSchema: "vegastack-labs.dev/database-export-draft-submission", Examples: []Example{{Summary: "Create an inert authorized sanitized control-data export draft.", Arguments: []string{"database", "export", "--config", "fixture/server-profile.json", "--file", "fixture/database-export-request.json", "--output", "json"}}}},
	{Path: []string{"database", "restore"}, Summary: "Create an inert control-database restore change.", Availability: "available", OwnerPhase: "5", Risk: "mutation", Flags: []Flag{{Name: "--config", Kind: "value", ValueName: "path", Required: true, Repeatable: false, Summary: "Read one protected server profile.", Enum: []string(nil)}, {Name: "--file", Kind: "value", ValueName: "path", Required: true, Repeatable: false, Summary: "Read one exact material-free database operation request JSON file.", Enum: []string(nil)}, {Name: "--output", Kind: "value", ValueName: "format", Required: false, Repeatable: false, Summary: "Select human or versioned JSON output.", Enum: []string{"human", "json"}}, {Name: "--schema-version", Kind: "value", ValueName: "major", Required: false, Repeatable: false, Summary: "Select the machine-contract schema major.", Enum: []string{"1"}}}, RequestSchema: "vegastack-labs.dev/restore-request", ResultSchema: "vegastack-labs.dev/run-result", DataSchema: "vegastack-labs.dev/restore-binding", Examples: []Example{{Summary: "Create an inert control-database restore change.", Arguments: []string{"database", "restore", "--config", "fixture/server-profile.json", "--file", "fixture/database-restore-request.json", "--output", "json"}}}},
	...
	{Path: []string{"database", "verify"}, Summary: "Verify control-database integrity or backup content.", Availability: "available", OwnerPhase: "5", Risk: "mutation", Flags: []Flag{{Name: "--config", Kind: "value", ValueName: "path", Required: true, Repeatable: false, Summary: "Read one protected server profile.", Enum: []string(nil)}, {Name: "--file", Kind: "value", ValueName: "path", Required: true, Repeatable: false, Summary: "Read one exact material-free database operation request JSON file.", Enum: []string(nil)}, {Name: "--output", Kind: "value", ValueName: "format", Required: false, Repeatable: false, Summary: "Select human or versioned JSON output.", Enum: []string{"human", "json"}}, {Name: "--schema-version", Kind: "value", ValueName: "major", Required: false, Repeatable: false, Summary: "Select the machine-contract schema major.", Enum: []string{"1"}}}, RequestSchema: "vegastack-labs.dev/backup-verify-request", ResultSchema: "vegastack-labs.dev/run-result", DataSchema: "vegastack-labs.dev/backup-job", Examples: []Example{{Summary: "Verify control-database integrity or backup content.", Arguments: []string{"database", "verify", "--config", "fixture/server-profile.json", "--file", "fixture/database-verify-request.json", "--output", "json"}}}},
...
var Endpoints = []Endpoint{
	...
	{ID: "api.v1.database-backups.create", Method: "POST", Path: "/api/v1/database/backups", Availability: "available", OwnerPhase: "5", QuerySchema: "", RequestSchema: "vegastack-labs.dev/backup-run-request", DataSchema: "vegastack-labs.dev/backup-job", Stream: "finite", Audiences: []string{"operator"}, RequestEncoding: "", TransportScope: "", MaxRequestBytes: 0},
	{ID: "api.v1.database-exports.create", Method: "POST", Path: "/api/v1/database/exports", Availability: "available", OwnerPhase: "5", QuerySchema: "", RequestSchema: "vegastack-labs.dev/database-export-request", DataSchema: "vegastack-labs.dev/database-export-draft-submission", Stream: "finite", Audiences: []string{"operator"}, RequestEncoding: "", TransportScope: "", MaxRequestBytes: 0},
	{ID: "api.v1.database-restores.create", Method: "POST", Path: "/api/v1/database/restores", Availability: "available", OwnerPhase: "5", QuerySchema: "", RequestSchema: "vegastack-labs.dev/restore-request", DataSchema: "vegastack-labs.dev/restore-binding", Stream: "finite", Audiences: []string{"operator"}, RequestEncoding: "", TransportScope: "", MaxRequestBytes: 0},
	...
	{ID: "api.v1.database-verifications.create", Method: "POST", Path: "/api/v1/database/verifications", Availability: "available", OwnerPhase: "5", QuerySchema: "", RequestSchema: "vegastack-labs.dev/backup-verify-request", DataSchema: "vegastack-labs.dev/backup-job", Stream: "finite", Audiences: []string{"operator"}, RequestEncoding: "", TransportScope: "", MaxRequestBytes: 0},
