...
var Endpoints = []Endpoint{
	...
	{ID: "api.v1.declarations.revise", Method: "POST", Path: "/api/v1/declarations", Availability: "available", OwnerPhase: "4", QuerySchema: "", RequestSchema: "vegastack-labs.dev/declaration-revision-request", DataSchema: "vegastack-labs.dev/declaration-revision", Stream: "finite", Audiences: []string{"browser", "operator"}},
	...
	{ID: "api.v1.plans.create", Method: "POST", Path: "/api/v1/plans", Availability: "available", OwnerPhase: "4", QuerySchema: "", RequestSchema: "vegastack-labs.dev/plan-create-request", DataSchema: "vegastack-labs.dev/plan", Stream: "finite", Audiences: []string{"browser", "operator"}},
