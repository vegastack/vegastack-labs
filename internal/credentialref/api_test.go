...
var allowedCredentialAPI = []string{
	...
	`const ActionStage LifecycleAction = "credential.stage"`,
	`const ActionActivate LifecycleAction = "credential.activate"`,
	`const ActionRotate LifecycleAction = "credential.rotate"`,
	`const ActionRevoke LifecycleAction = "credential.revoke"`,
	`const ActionRecover LifecycleAction = "credential.recover"`,
	`const MaxLifecycleConsumers = 64`,
	`const MaxLifecycleOverlapSeconds = 3600`,
	`type LifecycleAction string`,
	`type LifecycleBinding struct`,
	`type ConsumerVerification struct`,
	`type RecoveryVerification struct`,
	`field LifecycleBinding.OperationID string`,
	`field LifecycleBinding.Action LifecycleAction`,
	...
	`field LifecycleBinding.RequiredDeniedConsumerIDs []string`,
	`field LifecycleBinding.NativeConsumers []NativeConsumerBinding`,
	`field LifecycleBinding.NativeDeniedReaders []NativeDeniedReaderBinding`,
	`type NativeConsumerBinding struct`,
	`type NativeDeniedReaderBinding struct`,
	`field NativeConsumerBinding.ConsumerID string`,
	`field NativeConsumerBinding.TargetID string`,
	`field NativeConsumerBinding.HostMachineID string`,
	`field NativeConsumerBinding.UnitName string`,
	`field NativeConsumerBinding.ServiceUID uint32`,
	`field NativeConsumerBinding.ServiceGID uint32`,
	`field NativeConsumerBinding.ProfileID string`,
	`field NativeConsumerBinding.RoleID string`,
	`field NativeConsumerBinding.LoadedName string`,
	`field NativeDeniedReaderBinding.ConsumerID string`,
	`field NativeDeniedReaderBinding.TargetID string`,
	`field NativeDeniedReaderBinding.HostMachineID string`,
	`field NativeDeniedReaderBinding.ReaderUID uint32`,
	`field NativeDeniedReaderBinding.ReaderGID uint32`,
	`field NativeDeniedReaderBinding.ProfileID string`,
	`field NativeDeniedReaderBinding.RoleID string`,
	`field LifecycleBinding.MaterialVersion string`,
	`field LifecycleBinding.PriorMaterialVersion *string`,
	`field LifecycleBinding.ResolverID string`,
	`field LifecycleBinding.TargetID string`,
	`field LifecycleBinding.CiphertextFingerprint string`,
	`field LifecycleBinding.OverlapSeconds int64`,
	`field LifecycleBinding.StateRevision int64`,
	`field LifecycleBinding.RecoveryEpoch int64`,
	`field LifecycleBinding.PriorRecoveryEpoch *int64`,
	`field LifecycleBinding.CustodyProofDigest *string`,
	`field LifecycleBinding.FormerControllerFenceDigest *string`,
	`field ConsumerVerification.ConsumerID string`,
	`field ConsumerVerification.ProfileID string`,
	`field ConsumerVerification.RoleID string`,
	`field ConsumerVerification.MaterialVersion string`,
	`field ConsumerVerification.CiphertextFingerprint string`,
	`field ConsumerVerification.EvidenceDigest string`,
	`field ConsumerVerification.RestartObserved bool`,
	`field ConsumerVerification.Result string`,
	`field ConsumerVerification.ReasonCode string`,
	`field RecoveryVerification.DraftID string`,
	`field RecoveryVerification.CustodyProofDigest string`,
	`field RecoveryVerification.FormerControllerFenceDigest string`,
	`field RecoveryVerification.PriorRecoveryEpoch int64`,
	`field RecoveryVerification.RecoveryEpoch int64`,
	`field RecoveryVerification.EvidenceDigest string`,
	`method LifecycleBinding.Digest func() (string)`,
	`func ValidLifecycleBinding func(LifecycleBinding) (bool)`,
	`func ValidNativeBindings func(LifecycleBinding) (bool)`,
	`func LoadedNameForVersion func(string, string, string) (string)`,
	...
	`func LifecycleTargetDigest func(generated.CredentialLifecycleRequest) (string)`,
	`func NewConsumerVerification func(LifecycleBinding, string, string, string, string, string, string, bool) (ConsumerVerification, error)`,
	`func NewRecoveryVerification func(LifecycleBinding, string, string, string) (RecoveryVerification, error)`,
	...
	`func ValidConsumerVerification func(LifecycleBinding, ConsumerVerification) (bool)`,
	`func ValidReasonCode func(string) (bool)`,
	`func ValidRecoveryVerification func(LifecycleBinding, RecoveryVerification) (bool)`,
	`func ValidSHA256Digest func(string) (bool)`,
