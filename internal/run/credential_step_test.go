...
func (source *fakeCredentialBindings) GetReference(context.Context, string) (generated.CredentialReference, error) {
...
func TestCredentialStepRechecksAppliedReferenceAndExactLease(t *testing.T) {
	...
	if err != nil || len(values) != 1 || resolver.calls != 1 || validator.calls != 2 {
