...
const PHASE2_BASELINE_MUTATION_DIGEST = "sha256:ec30a4cc9d4a6e5a3fc9817a55a5b0a1697adcae57b950325edd563637d308a8";
...
// #109 adds exact fixed policy drafts and protected local dispatch through the
// shared plan, authorization and run engines.
const REVIEWED_SCHEDULE_WAVE = Object.freeze({
  id: "phase5-issue109-v1", issue: 109,
  commands: Object.freeze(["schedule cancel", "schedule dispatch", "schedule policy draft"]), imports: Object.freeze([`${MODULE_PREFIX}internal/schedule`]),
  mutationBoundaryDigest: "sha256:11b278dfc2431beb4910d958b4ef05ae5204ebc95061363790a96c9a8a129144",
});

// #110 exposes the reviewed Phase 5 operator workflows across the CLI, API,
// and Console. Database export creates only a server-owned inert draft.
const REVIEWED_OPERATOR_SURFACES_WAVE = Object.freeze({
  id: "phase5-issue110-v1", issue: 110,
  commands: Object.freeze(["database backup", "database export", "database restore", "database verify", "schedule inspect", "schedule list"]),
  imports: Object.freeze([`${MODULE_PREFIX}internal/databaseexport`]),
  mutationBoundaryDigest: "sha256:ec30a4cc9d4a6e5a3fc9817a55a5b0a1697adcae57b950325edd563637d308a8",
});

// #186 repairs the already reviewed recovery, backup and store contracts after
// the final Linux acceptance exposed stale fixtures and reserved-connection
// deadlocks. It adds no command or import; this wave seals the exact clean
// reviewed source closure at a2306cc9.
const REVIEWED_LINUX_ACCEPTANCE_REPAIR_WAVE = Object.freeze({
  id: "phase5-issue186-v1", issue: 186,
  commands: Object.freeze([]), imports: Object.freeze([]),
...
export function validateEvidence(manifest, facts) {
  ...
  const reviewedCommandPrefixes = ["gate ", "credential ", "audit ", "backup ", "recovery witness ", "restore ", "schedule "];
