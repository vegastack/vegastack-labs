...
export const REQUIRED_PHASE5_SCENARIOS = Object.freeze([
  ...
  requiredScenario("audit.concurrent-chain-single", "5.6", 107, "audit", "go-test",
    "internal/store/audit_chain_linux_test.go", "TestConcurrentAuditIntentsCannotForkChain", "built-linux", "single-chain", 3, "phase5-concurrency-v1"),
  ...
  requiredScenario("schedule.overlap-single", "5.8", 109, "schedule", "go-test",
    "internal/schedule/service_test.go", "TestDispatchUsesServerClockAndOneDurableSlot", "fixture", "single-occurrence", 3, "phase5-concurrency-v1"),
  ...
  requiredScenario("suite.durable-boundary-complete", "5.10", 111, "suite", "go-test",
    "internal/run/engine_test.go", "TestRestartAtEveryDurableBoundaryNeverRepeatsAmbiguousEffect", "fixture", "complete"),
  ...
  requiredScenario("suite.deterministic-repeat", "5.10", 111, "suite", "node-test",
    "tooling/test/phase-5-acceptance.test.mjs", "Phase 5 exact-pass parsers enforce repeat counts", "fixture", "deterministic"),
]);
