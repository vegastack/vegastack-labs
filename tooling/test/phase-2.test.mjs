...
test("current development pointers preserve Phase 2 and Phase 3 acceptance", async () => {
  ...
  assert.match(index, /Phase 2.*accepted.*Phase 3.*accepted.*a0a07a425d6396703d8bec438634d9ec2c2ae980/is);
  assert.match(roadmap, /Phase 2.*10-09-2026.*Phase 3.*12-09-2026.*a0a07a425d6396703d8bec438634d9ec2c2ae980/is);
