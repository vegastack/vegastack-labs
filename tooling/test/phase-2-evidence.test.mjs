...
test("the original Phase 2 baseline stays immutable while Phase 5 waves through #153 have exact reviewed closures", async () => {
  ...
  assert.equal(manifest.contract.reviewedWaves?.length, 15);
  ...
  assert.equal(facts.postPhase2MutationBoundaryDigest, manifest.contract.reviewedWaves[14].mutationBoundaryDigest);
