...
test("the original Phase 2 baseline stays immutable while #104, #123, #128, #124, #107, #125, and #132/#133/#134/#146 have exact reviewed waves", async () => {
  ...
  assert.equal(manifest.contract.reviewedWaves[10].id, "phase5-issue153-v1");
  assert.equal(manifest.contract.reviewedWaves[10].issue, 153);
  assert.deepEqual(manifest.contract.reviewedWaves[10].commands, ["recovery witness collect"]);
  assert.deepEqual(manifest.contract.reviewedWaves[10].imports, ["github.com/vegastack/vegastack-labs/internal/adapter/recoverydenial"]);
