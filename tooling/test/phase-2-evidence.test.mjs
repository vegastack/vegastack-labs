...
test("the original Phase 2 baseline stays immutable while #104, #123, #128, #124, #107, #125, and #132/#133/#146 have exact reviewed waves", async () => {
  ...
  assert.equal(manifest.contract.reviewedWaves[8].id, "phase5-issue146-v1");
  assert.equal(manifest.contract.reviewedWaves[8].issue, 146);
  assert.deepEqual(manifest.contract.reviewedWaves[8].commands, []);
  assert.deepEqual(manifest.contract.reviewedWaves[8].imports, ["github.com/vegastack/vegastack-labs/internal/recovery"]);
