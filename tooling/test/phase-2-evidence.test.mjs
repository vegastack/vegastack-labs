...
test("the original Phase 2 baseline stays immutable while the reviewed Phase 5 waves include #108's dormant preflight", async () => {
  ...
  assert.equal(manifest.contract.reviewedWaves[9].id, "phase5-issue108-preflight-v1");
  assert.equal(manifest.contract.reviewedWaves[9].issue, 108);
