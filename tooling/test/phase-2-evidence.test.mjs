...
test("the original Phase 2 baseline stays immutable while Phase 5 waves through #110 have exact reviewed closures", async () => {
  ...
  assert.equal(manifest.contract.postPhase2MutationBoundaryDigest, "sha256:377fa4c6d0463d2efedd93a46aa3f41d956a4db1364926741e0986ea545d0211");
  ...
  assert.equal(manifest.contract.reviewedWaves[27].mutationBoundaryDigest, "sha256:377fa4c6d0463d2efedd93a46aa3f41d956a4db1364926741e0986ea545d0211");
