...
test("the original Phase 2 baseline stays immutable while Phase 5 waves through #110 have exact reviewed closures", async () => {
  ...
  assert.equal(manifest.contract.postPhase2MutationBoundaryDigest, "sha256:c230ea19a7dc1d5ea5a1d6f4e26e33776054e332cce41a14218b18150d3e96e4");
  ...
  assert.equal(manifest.contract.reviewedWaves[27].mutationBoundaryDigest, "sha256:c230ea19a7dc1d5ea5a1d6f4e26e33776054e332cce41a14218b18150d3e96e4");
